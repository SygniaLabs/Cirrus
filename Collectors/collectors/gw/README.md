...
- **Logs:** log events captured across Google Workspace and Cloud Identity **(log visibility depends on subscription level)**
...
| **Send As**              | Lists the send-as aliases for the specified user. The result includes the primary send-as address associated with the account as well as any custom "from" aliases.                                                                                                  | 
...
| **Auto Forwarding**      | List auto-forwarding settings for a user.                                                                                                                                                                                                                            | 
| **Forwarding Addresses** | Lists the forwarding addresses for the specified user.                                                                                                                                                                                                               | 
...
service account parent project. We recommend using the [Cirrus Assistant](../../../Assistant/README.md) script to facilitate access to a Google Cloud 
...
_Note: Threads and Messages can be queries by the Gmail search language as can be found here: https://support.google.com/mail/answer/7190?hl=en_
...
### Required APIs
Use of the Cirrus Workspace Collector requires that the Admin SDK and Gmail APIs are enabled in the service account parent project. 
